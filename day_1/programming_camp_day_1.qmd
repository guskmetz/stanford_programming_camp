...
```{r}
rownames(installed.packages(priority="NA"))
```
...
```
\centering
[Atlantic Hurricane Tracks](https://www.gastonsanchez.com/R-tidy-hurricanes/maps-ggplot.html)
