...
\begin{figure}[!htbp]
     \begin{centering}
     \caption{Half Dome and Nevada Falls from Panoramic Trail}
     \includegraphics[width=0.8\textwidth]{figures/yosemite.jpg}
     \end{centering}
\end{figure}
...
\begin{figure}[!htbp]
     \begin{centering}
     \caption{Russian Ridge}
     \includegraphics[width=0.8\textwidth]{figures/long_commute.jpg}
     \end{centering}
\end{figure}
...
\begin{figure}[!htbp]
     \begin{centering}
     \includegraphics[width=0.8\textwidth]{figures/code_quality.png}
     \end{centering}
\end{figure}
...
\begin{figure}[!htbp]
     \begin{centering}
     \includegraphics[width=0.8\textwidth]{figures/real_programmers.png}
     \end{centering}
\end{figure}
...
\begin{figure}[!htbp]
     \begin{centering}
     \caption{RStudio Cloud Landing Page}
     \includegraphics[width=0.8\textwidth]{figures/rstudio_cloud_landing.jpg}
     \end{centering}
\end{figure}
...
\begin{figure}[!htbp]
     ...
     \includegraphics[width=0.8\textwidth]{figures/rstudio_cloud_new_project.jpg}
     \end{centering}
\end{figure}
...
\begin{figure}[!htbp]
     \begin{centering}
     \caption{Save a Permanent Copy}
     \includegraphics[width=0.8\textwidth]{figures/rstudio_cloud_save_permanent_copy.jpg}
     \end{centering}
\end{figure}
...
```{r, eval = F}
function_name(arugment_1 = value_1, 
              argument_2 = value_2,
              ...,
              argument_n = value_n)
```
...
\begin{figure}[!htbp]
     \begin{centering}
     \includegraphics[width=0.8\textwidth]{figures/base_r.jpg}
     \end{centering}
\end{figure}
...
\begin{figure}[!htbp]
     \begin{centering}
     \includegraphics[width=0.8\textwidth]{figures/r_packages.jpg}
     \end{centering}
\end{figure}
...
\centering
\animategraphics[loop, autoplay]{20}{figures/dino_gif/frame-}{0}{294}
...
\begin{figure}[!htbp]
     \begin{centering}
     \caption{Population Weighted Distribution of Taste}
     \includegraphics[width=0.8\textwidth]{figures/deposit_spread.pdf}
     \end{centering}
\end{figure}
...
\begin{figure}[!htbp]
     \begin{centering}
     \caption{Distribution of Taste by Age}
     \includegraphics[width=0.8\textwidth]{figures/deposit_spread_age.pdf}
     \end{centering}
\end{figure}
...
\begin{figure}[!htbp]
     \begin{centering}
     \caption{Atlantic Hurricane Tracks}
     \includegraphics[width=0.8\textwidth]{figures/hurricane_tracks.jpeg}
     \end{centering}
\end{figure}
...
\begin{figure}[!htbp]
     \begin{centering}
     \includegraphics[width=0.8\textwidth]{figures/programming_camp_day_1_elements_of_plot.jpg}
     \end{centering}
\end{figure}
...
\begin{figure}[!htbp]
     \begin{centering}
     \includegraphics[width=0.5\textwidth]{figures/programming_camp_day_1_complete_plot.jpg}
     \end{centering}
\end{figure}
...
\begin{figure}[!htbp]
     \begin{centering}
     \includegraphics[width=0.8\textwidth]{figures/discrete_vs_continous_aes.jpg}
     \end{centering}
\end{figure}
